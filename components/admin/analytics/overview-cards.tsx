...
export function OverviewCards({ data, isLoading }: OverviewCardsProps) {
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">
            +{data.newUsersLast30Days} за последние 30 дней
          </p>
        </CardContent>
      </Card>
      <Card>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium">Зачисления</CardTitle>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium">ДЗ на проверке</CardTitle>
          <FileText className="h-4 w-4 text-muted-foreground" />
        </CardHeader>
        <CardContent>
          <div className="text-2xl font-bold">{data.pendingHomeworks}</div>
        </CardContent>
      </Card>
    </div>
  );
